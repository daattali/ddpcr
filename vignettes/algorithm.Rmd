...
```{r outliers-img, echo=FALSE, warning=FALSE, include=FALSE, message=FALSE, cache=TRUE}
dir.create("algorithm_img", showWarnings = FALSE)
...
p1 <- arrangeGrob(p1, top = textGrob("A", x = unit(0, "npc"), y = unit(1, "npc"), just=c("left","top"), gp=gpar(col="black", fontsize=20, fontfamily="Times Roman", fontface="bold")))
p2 <- arrangeGrob(p2, top = textGrob("B", x = unit(0, "npc"), y = unit(1, "npc"), just=c("left","top"), gp=gpar(col="black", fontsize=20, fontfamily="Times Roman", fontface="bold")))
p3 <- arrangeGrob(p3, top = textGrob("C", x = unit(0, "npc"), y = unit(1, "npc"), just=c("left","top"), gp=gpar(col="black", fontsize=20, fontfamily="Times Roman", fontface="bold")))
#png("algorithm_img/outliers.png", width = 1000, height = 300)
grid.arrange(p1, p2, p3, ncol = 3)
#dev.off()
```

[![Remove outliers](algorithm_img/outliers.png)](algorithm_img/outliers.png)
...
```{r empty-img, echo=FALSE, warning=FALSE, include=FALSE, message=FALSE, cache=TRUE}
library(ggplot2)
library(ddpcr)
library(grid)
library(gridExtra)
...
p1 <- arrangeGrob(p1, top = textGrob("A", x = unit(0, "npc"), y = unit(1, "npc"), just=c("left","top"), gp=gpar(col="black", fontsize=20, fontfamily="Times Roman", fontface="bold")))
p2 <- arrangeGrob(p2, top = textGrob("B", x = unit(0, "npc"), y = unit(1, "npc"), just=c("left","top"), gp=gpar(col="black", fontsize=20, fontfamily="Times Roman", fontface="bold")))
#png("algorithm_img/empty.png", width = 700, height = 300)
grid.arrange(p1, p2, ncol = 2)
#dev.off()
```

[![Remove empty](algorithm_img/empty.png)](algorithm_img/empty.png)
